...
var uberRemoteControl = function(ui_url, system){	
	...
	var markup = "\
			<div id='rcframe' style='z-index:99999!important;'>\
				<iframe style='z-index:99999!important;' src='"+document.home+ui_url+"?source="+encodeURIComponent(document.location)+"#"+encodeURIComponent(document.location.protocol+"//"+document.location.host)+"' onload=\"window.__uber.rc.wireCommands()\">Enable iFrames.</iframe>\
				<style type='text/css'>\
